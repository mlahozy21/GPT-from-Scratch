...
TinyStories. The code is a compact, reproducible reference for how a modern GPT is
built and trained.
\end{abstract}
...
initialisation, and generates coherent short stories, e.g. for the prompt
\emph{``Once upon a time''} it continues with a complete, on-topic narrative about
two friends playing in a park.
...
$\mu$P or careful LR scaling, and longer context.
